...
namespace OneRare.FoodFury.Multiplayer
{
	public struct ShotState : ISparseState<Shot>
	{
		...
		private Vector3 GetDirectionAt(float t, Shot prefab) => prefab.Speed == 0
			? Direction
			: (prefab.Speed * Direction + t * prefab.Gravity).normalized;
	}

	public class Shot : MonoBehaviour, ISparseVisual<ShotState, Shot>
	{
		[Header("Settings")] [SerializeField] private Vector3 _gravity;
