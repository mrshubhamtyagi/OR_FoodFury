...
namespace FusionHelpers
{
    ...
    public class FusionLauncher : MonoBehaviour, INetworkRunnerCallbacks
    {
            ...
            Action<NetworkRunner, ConnectionStatus, string> onConnect)
        {
            ...
            /*if (GameData.Instance.serverMode == Enums.ServerMode.TestNet)
            ...
            scene.AddSceneRef(SceneRef.FromIndex(SceneManagerUnity.SceneManager.GetActiveScene().buildIndex));
        ...
        {
            //Debug.Log($"OnPlayerJoined: - {player} | Local - {runner.LocalPlayer == player}");
        ...
        public void OnShutdown(NetworkRunner runner, ShutdownReason shutdownReason)
        {
            ...
            switch (shutdownReason)
            {
                ...
                default:
                    ...
                    Debug.LogError($"OnShutdown: {message}");
